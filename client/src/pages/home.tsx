          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <div className="flex flex-col gap-2 items-start">
                ...
                <p
                  className={`text-purple-700 font-medium text-sm line-clamp-1 ${
                    isRTL ? "text-right" : "text-left"
                  }`}
                  dir={isRTL ? "rtl" : "ltr"}
                >
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  data-testid={`button-remove-journey-${savedJourney.id}`}
                >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>
                    {isRTL ? "הסר מסע מהרשימה" : "Remove Journey"}
                  </AlertDialogTitle>
                  <AlertDialogDescription>
                    {isRTL
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    onClick={() => onRemove(savedJourney.id)}
...
export default function Home() {
  ...
  const { data: savedJourneys = [], isLoading: savedJourneysLoading } =
    useQuery<any[]>({
  ...
  const removeSavedJourneyMutation = useMutation({
    ...
    onMutate: async (savedJourneyId: number) => {
      console.log(
        "onMutate - Removing saved journey optimistically:",
        savedJourneyId
      );
      await queryClient.cancelQueries({ queryKey: ["/api/saved-journeys"] });

      const previousSavedJourneys = queryClient.getQueryData([
        "/api/saved-journeys",
      ]);
      ...
      queryClient.setQueryData(["/api/saved-journeys"], (old: any[]) => {
        ...
        const filtered = old
          ? old.filter((sj: any) => sj.id !== savedJourneyId)
          : [];
  ...
  const deleteTripMutation = useMutation({
    ...
    onMutate: async (tripId: number) => {
      ...
      queryClient.setQueryData(["/api/trips/user"], (old: any[]) => {
        ...
        const filtered = old
          ? old.filter((trip: any) => trip.id !== tripId)
          : [];
  ...
  const formatPrice = (
    ...
    return formatCurrencyRange(min, max, i18n.language as "en" | "he");
  };
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-200">
              <Button
                asChild
                size="lg"
                className="bg-white text-orange-600 hover:bg-gray-100 px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105"
              >
                <Link href="/my-trips">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-white text-orange-600 hover:bg-white hover:text-orange-600 px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 mb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <StatsCard
            icon={MapPin}
            value={
              statsLoading ? "..." : `${platformStats?.destinations || 0}+`
            }
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FeatureCard
            ...
            description={
              t("home.ai_planning_desc") ||
              "Get personalized itineraries tailored to your preferences"
            }
          ...
          <FeatureCard
            ...
            description={
              t("home.budget_tracking_desc") ||
              "Track expenses and stay within your budget effortlessly"
            }
          ...
          <FeatureCard
            ...
            description={
              t("home.verified_places_desc") ||
              "Book hotels, flights and vacation packages at the best prices with excellent customer service and 24/7 support"
            }
          ...
          <FeatureCard
            ...
            description={
              t("home.curated_journeys_desc") ||
              "Pre-planned multi-city adventures"
            }
          ...
          <FeatureCard
            ...
            description={
              t("home.real_time_desc") ||
              "Live weather data and travel recommendations"
            }
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                >
                  <Link href="/my-journeys">{t("home.view_all")}</Link>
                </Button>
              </div>
            ...
            <section className="mt-12">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button
                  variant="outline"
                  className="hover:bg-teal-50 hover:border-teal-500 hover:text-teal-700 transition-all"
                >
                  {t("home.view_all")}
                </Button>
              </div>
            ...
            <Card className="border-t-4 border-t-blue-500 shadow-lg hover:shadow-xl transition-all">
              ...
              <CardContent className="space-y-3">
                <Button
                  asChild
                  variant="outline"
                  className="w-full justify-start hover:bg-orange-50 hover:border-orange-500 hover:text-orange-700 transition-all"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="w-full justify-start hover:bg-purple-50 hover:border-purple-500 hover:text-purple-700 transition-all"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="w-full justify-start hover:bg-teal-50 hover:border-teal-500 hover:text-teal-700 transition-all"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="w-full justify-start hover:bg-blue-50 hover:border-blue-500 hover:text-blue-700 transition-all"
                >
            ...
            <Card className="border-t-4 border-t-orange-500 shadow-lg hover:shadow-xl transition-all">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors">
                  <span className="text-gray-700 font-medium">
                    {t("home.reviews_written")}
                  </span>
                  <Badge className="bg-blue-600 text-white">
                    {
                      reviews.filter(
                        (r: any) => r.userId === (user?.id || "demo-user")
                      ).length
                    }
                  </Badge>
                </div>
            ...
            <Card className="border-t-4 border-t-teal-500 shadow-lg hover:shadow-xl transition-all">
              ...
              <CardContent>
                {reviewsLoading ? (
                  ...
                  <div className="space-y-4">
                    {reviews.slice(0, 3).map((review: any) => (
                      <div
                        key={review.id}
                        className="border-b border-gray-100 last:border-0 pb-3 last:pb-0 hover:bg-gray-50 p-2 rounded transition-colors"
                      >
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full mt-4 hover:bg-teal-50 hover:border-teal-500 hover:text-teal-700 transition-all"
                >
                  <Link href="/community">{t("home.view_all_activity")}</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
...
function StatsCard({
  ...
  return (
    <Card
      className={`bg-gradient-to-br ${gradient} text-white border-0 shadow-lg hover:shadow-xl hover:scale-105 transition-all cursor-pointer`}
    >
...
function FeatureCard({
  ...
  return (
    <Link href={href}>
      <Card
        className={`bg-gradient-to-br ${gradient} border-0 shadow-md hover:shadow-xl hover:scale-105 transition-all cursor-pointer group h-full`}
      >
        <CardContent className="p-6 h-full flex flex-col">
          <div
            className={`${iconColor} mb-4 group-hover:scale-110 transition-transform`}
          >
...
function PopularJourneysSection() {
  ...
  > = {
    "Southeast Asia Adventure": {
      ...
      description:
        "מבנגקוק התוססת למקדשים שלווים וחופים גן עדן - חוויית תאילנד האולטימטיבית",
    },
    "Southeast Asia Multi-Country": {
      title: "הרפתקה בדרום מזרח אסיה",
      description:
        "מסע אפי דרך תאילנד, אינדונזיה וסינגפור, חוויית חופים, תרבות וקולינריה מרהיבה",
    },
    "Japan Extended Discovery": {
      title: "מסע מורחב ביפן",
      description:
        "מסע סוחף דרך הערים האייקוניות של יפן, מאורות הניאון של טוקיו להירושימה",
    },
    "Classic Japan Circuit": {
      title: "מעגל יפן קלאסי",
      description:
        "גלו את השילוב המושלם של מסורות עתיקות וחדשנות מודרנית בערים האייקוניות של יפן",
    },
    "Grand European Journey": {
      title: "מסע אירופי גדול",
      description:
        "חוויה אירופית מקיפה דרך חמש ערים אגדיות, מהרומנטיקה של פריז לקסם של ברלין",
    },
  };
  ...
  const translateJourney = (journey: any) => {
    ...
    return (
      translation || { title: journey.title, description: journey.description }
    );
  };
  ...
  const formatDestinations = (destinations: any) => {
    ...
    const cityNames = Array.isArray(destinations)
      ? destinations.map((d) =>
          typeof d === "string" ? d : d.city || d.name || d
        )
      : [];
    ...
    <section className="mt-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          ...
          className="hover:bg-purple-50 hover:border-purple-500 hover:text-purple-700 transition-all"
        >
          <Link href="/journeys">{t("home.view_all")}</Link>
        </Button>
      </div>
              ...
              <Card className="hover:shadow-xl transition-all cursor-pointer group border-t-4 border-t-purple-500 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <h3
                      className="text-lg font-bold text-slate-800 group-hover:text-purple-700 transition-colors"
                      dir={isRTL ? "rtl" : "ltr"}
                    >
                      {translated.title}
                    </h3>
                    <Badge className="bg-purple-600 text-white">
                      {journey.totalNights || journey.total_nights}{" "}
                      {t("journeys.nights")}
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    {(journey.priceMin || journey.price_min) &&
                      (journey.priceMax || journey.price_max) && (
                        <div className="flex flex-col items-end">
                          ...
                          >
                            {isRTL
                              ? `₪${Math.round(
                                  (journey.priceMax || journey.price_max) * 3.5
                                ).toLocaleString("he-IL")} - ₪${Math.round(
                                  (journey.priceMin || journey.price_min) * 3.5
