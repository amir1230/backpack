          ...
          <CardContent>
            <div className="space-y-3">
              {(recentExpenses || []).map((expense, index) => {
                ...
                return (
                  <div key={expense.id}>
                    <div className={`flex items-end justify-between py-2 ${i18n.language === 'he' ? 'flex-row-reverse' : ''}`}>
                      <div className={`flex items-end gap-3 ${i18n.language === 'he' ? 'flex-row-reverse' : ''}`}>
